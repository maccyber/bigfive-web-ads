    ...
    <Wrapper>
      <v-row cols="12" class="py-10">
        <v-col cols="12" xs="12" md="6" class="text-md-left text-center">
          ...
          <p :class="{ 'responsive-text': display.smAndDown }" v-html="$t('frontpage.description.top')" />
          <p :class="{ 'responsive-text': display.smAndDown }" v-html="$t('frontpage.description.info')" />
