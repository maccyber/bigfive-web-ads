...
inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
  ...
  opennessToExperience: {
    ...
    text1: `
      ...
      <p>
        Osoby otwarte są <b>ciekawe świata, doceniające sztukę i wrażliwe na piękno</b>.
        W porównaniu z osobami zamkniętymi zwykle są bardziej <b>świadome swoich uczuć</b>.
        Działają i myślą w indywidualistyczny i nonkonformistyczny sposób.
      </p>
      <p>
        Intelektualiści najczęściej uzyskują wysoki wynik Otwartości na doświadczenie. W związku z tym czynnik ten bywa również nazywany "Kulturą" lub "Intelektem".
      </p>
    `,
    text2: `
      <p>
        Niemniej jednak chyba najlepiej postrzegać Intelekt jako jeden z wielu aspektów Otwartości na doświadczenie.
        Wyniki Otwartości na doświadczenie sa tylko w niewielkim stopniu powiązane z latami edukacji i wynikami standardowych testów inteligencji.
      </p>
      <p>
        Inną cechą otwartego stylu poznawczego jest łatwość myślenia symbolami i abstrakcjami, które dalekie są od konkretnego doświadczenia.
      </p>
      <p>
        W zależności od specyficznych zdolności intelektualnych określonej osoby, to symboliczne poznanie może przybrać różne formy. Mowa tutaj zarówno o myśleniu matematycznym, logicznym czy geometrycznym, jak i o zdolności do artystycznego i metaforycznego użycia języka, czy też do tworzenia kompozycji muzycznej lub działań w zakresie jednej z wielu sztuk wizualnych i performatywnych.
      </p>
      <div class="title">
        Niskie wyniki
      </div>
      <p>
        Osoby uzysujące <b>niskie wyniki</b> Otwartości na doświadczenie mają zwykle <b>wąskie i powszechne zainteresowania</b>.
      </p>
      <p>
        Wolą to, co <b>proste, bezpośrednie </b> i oczywiste od tego, co złożone, niejednoznaczne i subtelne.
      </p>
      <p>
        Mogą postrzegać sztukę i naukę z podejrzliwością, traktując te przedsięwzięcia jako zawiłe lub nie mające praktycznego zastosowania.
      </p>
      <p>
        Osoby zamknięte wolą to, co znane od tego co nowe. Są konserwatywne i odporne na zmiany.
      </p>
      <p>
        Otwartość jest często przedstawiana jako zdrowsza lub bardziej dojrzała przez psychologów, którzy w wielu przypadkach sami są otwarci na doświadczenia. Jednak zarówno otwarte jak i zamknięte style myślenia są przydatne w zależności od środowiska.
      </p>
      <p>
        Styl intelektualny osoby otwartej może być przydatny profesorowi, ale badania wykazały, że myślenie zamknięte wiąże się z lepszą wydajnością pracy w policji, sprzedaży i szeregu zawodów usługowych.
      </p>
      ...
      <p>
        Dla osób z dużą wyobraźnią rzeczywisty świat jest często zbyt prosty i zwyczajny.
      </p>
      <p>
        <b>Osoby o wysokich wynikach</b> w tej skali używają wyobraźni jako sposobu na tworzenie bogatszego i bardziej interesującego świata.
      </p>
      <p>
      <b>Osoby o niskich wynikach</b> w tej skali przykładają większą wagę do faktów.
      </p>
      ...
      <p>
      <b>Osoby o wysokich wynikach</b> w tej skali kochają piękno, zarówno w sztuce jak i w naturze. Łatwo się angażują w wydarzenia artystyczne i zjawiska przyrodnicze.
      </p>
      <p>
        Niekoniecznie są wykształceni artystycznie czy utalentowani - chociaż wielu będzie. Cechą charakterystyczną tych osób jest zainteresowanie i podziw dla naturalnego i sztucznego piękna.
      </p>
      <p>
        <b>Osoby o niskich wynikach</b>  w tej skali nie wykazują estetycznej wrażliwości i zainteresowania sztuką.
      </p>
      ...
      <p>
        Osoby emocjonalne mają dobry dostęp do swoich uczuć i dużą ich świadomość.
      </p>
      <p>
        Osoby o niskich wynikach w tej skali są mniej świadome swoich uczuć i zwykle nie wyrażają ich otwarcie.
      </p>
      ...
      <p>
        Osoby o wysokich wynikach Skłonności do ryzyka chętnie próbują nowych zajęć, podróżują do obcych krajów i doświadczają różnych rzeczy.
      </p>
      <p>
        Uważają to co jest im znane i rutynowe za nudne i chętnie wybiorą nową drogę do domu tylko dlatego, że jest inna.
      </p>
      <p>
        Osoby o niskich wynikach czują się niekomfortowo ze zmianą i preferują ustalony porządek.
      </p>
      ...
      <p>
        Intelekt i zainteresowania artystyczne to dwa najważniejsze, centralne aspekty Otwartości na doświadczenie. Osoby uzyskujące wysokie wyniki w tej dziedzinie lubią bawić się ideami.
      </p>
      <p>
        Są otwarte na nowe i niezwykłe pomysły, lubią dyskutować na tematy intelektualne. Doceniają także zagadki i łamigłówki. Osoby uzyskujące niskie wyniki Intelektu wolą mieć do czynienia z ludźmi lub rzeczami niż z pomysłami.
      </p>
      <p>
        Postzegają one ćwiczenia intelektualne jako stratę czasu.
      </p>
      <p>
        Kategorii Intelektu nie należy utożsamiać z inteligencją. Jest ona raczej stylem myślenia, a nie zdolnością intelektualną, chociaż osoby z wysokimi wynikami w tej kategorii mają nieco wyższe wyniki w standardowych testach inteligencji niż osoby o wynikach niskich.
      </p>
      ...
      <p>
        Liberalizm psychologiczny oznacza gotowość do kwestionowania autorytetu, konwencji i tradycyjnych wartości.
      </p>
      <p>
        W swojej najbardziej ekstremalnej postaci liberalizm psychologiczny może nawet reprezentować jawną wrogość do reguł, sympatię dla przestępców i zamiłowanie do niejasności, chaosu i nieporządku.
      </p>
      <p>
        Psychologiczni konserwatyści preferują raczej bezpieczeństwo i stabilność, jakie zapewnia im dostosowanie się do tradycji. Liberalizm psychologiczny i konserwatyzm nie są tożsame z przynależnością polityczną, ale z pewnością skłaniają jednostki do wyboru określonych partii politycznych.
      </p>
    `
  },
  neuroticismPage: {
