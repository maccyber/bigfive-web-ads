export default {
  ...
  frontpage: {
    ...
    tests_taken: 'Більш ніж 4.000.000 людей на даний момент пройшли тест',
    compare: {
...
inventory is from <i> Johnson's (2014) 120-item IPIP NEO-PI-R </ i> .`,
  ...
  getResult: {
    result: 'Результати',
    explanation: 'Якщо ви пройшли тест і зберегли свій ID, ви можете побачити результати, ввівши свій ID, наприклад',
