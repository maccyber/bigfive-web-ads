export default {
  ...
  frontpage: {
    ...
    tests_taken: 'Более 4.000.000 человек на данный момент приняло участие',
    compare: {
...
inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
  ...
  getResult: {
    result: 'Результаты',
    explanation: 'Если вы прошли тест и сохранили свой ID, вы можете увидеть результаты, введя свой ID, например',
