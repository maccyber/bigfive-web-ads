export default {
  language: 'Thai',
  seo: {
    keywords: 'แบบทดสอบบุคลิกภาพใหญ่ 5 อย่าง, แบบทดสอบบุคลิกภาพใหญ่ห้าอย่าง, บุคลิกภาพ 5 องค์ประกอบ, บุคลิกภาพ 5 ประการ, แบบทดสอบบุคลิกภาพ, b5 test, bigfive test, personality traits, bigfive, compare, free, jordan peterson'
  },
  frontpage: {
    seo: {
      title: 'ฟรีแบบทดสอบบุคลิกภาพใหญ่ 5 อย่าง แบบโอเพนซอร์ส',
      description: 'ทำแบบทดสอบบุคลิกภาพใหญ่ 5 อย่าง แบบโอเพ่นซอร์สฟรี เรียนรู้ที่จะรู้จักลักษณะบุคลิกภาพของคุณและเปรียบเทียบตัวเองกับคู่ของคุณ เพื่อนร่วมงาน เพื่อน หรือครอบครัวของคุณ'
    },
    title: 'แบบทดสอบบุคลิกภาพใหญ่ 5 อย่าง',
    call_to_action: 'ทําการทดสอบฟรีตอนนี้',
    no_registration: '* ไม่จำเป็นต้องลงทะเบียน',
    tests_taken: 'มีผู้เข้าร่วมการทดสอบมากกว่า 4.000.000 คน',
    compare: {
      title: 'เปรียบเทียบตัวเองกับผู้อื่น',
      text1: 'เปรียบเทียบตัวเองกับคู่ของคุณ เพื่อนร่วมงาน เพื่อน หรือครอบครัวของคุณ',
    ...
    description: {
      ...
      subtop: 'นี่',
      subtop2: ' เป็นแบบจำลองทางจิตวิทยาที่เชื่อถือได้และสามารถตรวจสอบได้ทางวิทยาศาสตร์เพื่อวัดบุคลิกภาพ',
...
ชุดวัดบุคลิกภาพจาก <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      ...
      result: 'หลังจากที่คุณทําการทดสอบเสร็จแล้ว คุณจะได้รับรายงานบุคลิกภาพโดยละเอียดในปัจจัยต่อไปนี้:',
  ...
  about: {
    seo: {
      ...
      description: 'บิ๊กไฟว์ มีทีมที่กระตือรือร้นและมีส่วนร่วมอย่างมาก ซึ่งพยายามอย่างต่อเนื่องที่จะผลักดัน บิ๊กไฟว์ ไปข้างหน้า.'
    }
  },
  toolbar: {
    home: 'หน้าหลัก',
  ...
  neuroticism: {
    ...
    seo: {
      ...
      description: 'อ่านเพิ่มเติมเกี่ยวกับปัจจัยความไม่เสถียรทางอารมณ์ในโมเดล b5'
    }
  },
  getCompare: {
    title: 'เปรียบเทียบบุคคลหรือทีม',
    description1: 'เปรียบเทียบผลลัพธ์จากการทดสอบบุคลิกภาพใหญ่ 5 อย่าง กับหลายๆ คน',
  ...
  results: {
    ...
    seo: {
      ...
      description: 'ดูบุคลิกภาพของฉันและเปรียบเทียบตัวเองในห้าปัจจัยต่อไปนี้: ความไม่เสถียรทางอารมณ์, การเปิดรับประสบการณ์ , ความพิถีพิถัน, ความสนใจต่อสิ่งภายนอก, ความยินยอมเห็นใจ'
    }
  },
  getResult: {
    result: 'ผลลัพธ์',
    explaination: 'หากคุณได้ทำการทดสอบและบันทึก ID ของคุณ คุณสามารถดูผลลัพธ์ได้ที่นี่ โดยพิมพ์ ID ที่คุณได้รับ เช่น ',
