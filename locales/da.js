...
innholdet er fra <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
  ...
  form: {
    ...
    informationText: 'De svar, du giver, bruges til at give dig et',
    mostAccurate: 'et så præcist resultat som muligt',
    readMoreAbout: 'Læs mere om',
    privacy: 'Personvern',
    nextButton: 'OK, neste spørsmål',
    declineButton: 'fortsett uten å dele',
    prefferedLanguage: 'Mit foretrukne sprog er',
    ...
    language: 'Språk',
    gender: 'Køn',
    confirmInfo: 'Bekræft oplysninger',
    confirm: 'Bekræft',
    toTestButton: 'Areit! Tag mig til testen'
  },
  test: {
    next: 'Næste',
    back: 'tilbage',
